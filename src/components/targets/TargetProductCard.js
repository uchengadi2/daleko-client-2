...
import TargetUpdateAndDeliveryForm from "./TargetUpdateAndDeliveryForm";
...
export default function TargetProductCard(props) {
            ...
            <Grid item style={{ width: "46.19%", border: "1px dotted grey" }}>
              <CardContent disableRipple>
                ...
                {product.salesPreference === "deal" && (
                  <Typography>
                    <span style={{ fontSize: 14, marginLeft: 10 }}>
                      <strong> Deal Instructions:</strong>
            ...
            <Grid item style={{ width: "26.50%", border: "1px dotted grey" }}>
              {product.pricePerUnit && (
                <TargetUpdateAndDeliveryForm
                  ...
                  dealComment={props.dealComment}
                  dealDeliveryMode={props.dealDeliveryMode}
                  dealCentralizedDeliveryLocation={
                    props.dealCentralizedDeliveryLocation
                  }
                  dealCentralizedAgreedDeliveryCost={
                    props.dealCentralizedAgreedDeliveryCost
                  }
                  dealDecentralizedDeliveryLocation={
                    props.dealDecentralizedDeliveryLocation
                  }
                  dealDecentralizedAgreedDeliveryCost={
                    props.dealDecentralizedAgreedDeliveryCost
                  }
                  showDealDeliveryCost={PropaneRounded.showDealDeliveryCost}
