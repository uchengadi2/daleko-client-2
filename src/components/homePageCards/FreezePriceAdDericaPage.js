...
import backgroundAd from "./../../assets/images/covers/homepage-ad.png";
...
export default function FreezePriceAdDericaPage(props) {
      ...
      {matchesMDUp ? (
        <Card className={classes.root} disableRipple={true}>
          <CardActionArea
            ...
            component={Link}
            to="/freezedericapagead"
            onClick={() => <FreezePriceDericaPageAd />}
          >
            <Grid
              container
              direction="row"
