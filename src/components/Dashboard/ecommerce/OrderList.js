  ...
  const renderDataGrid = () => {
    ...
    orderList.map((order, index) => {
      ...
      let row = {
        ...
        transactionNumber: order.transaction
          ? order.transaction.orderNumber
          : null,
        transactionId: order.transaction ? order.transaction.id : null,
        product: order.product,
        productName: order.product ? order.product.name : null,
        sku: order.product ? order.product.sku : null,
        productCategory: order.productCategory,
        productVendor: order.productVendor,
        quantityAdddedToCart: order.quantityAdddedToCart,
        orderedQuantity: order.orderedQuantity,
        orderedPrice: order.orderedPrice,
        currency: order.currency,
        currencyName: order.currency ? order.currency.name : null,
        customerName: order.customerName,
        customerPhoneNumber: order.customerPhoneNumber,
        customerEmailAddress: order.customerEmailAddress,
        recipientName: order.recipientName,
