...
function ConfirmStockAvailabilityForm(props) {
  ...
  const buttonContent = () => {
    return <React.Fragment>Update Stock Availability Status</React.Fragment>;
  };
  ...
  return (
    <div>
      <form id="confirmStockAvailabilityForm" className={classes.formStyles}>
        <Grid
          item
          container
        ...
        <Grid item container style={{ marginTop: 20 }} justifyContent="center">
          <FormLabel
            ...
            component="legend"
          >
            <Typography variant="h5">Stock Availability</Typography>
          </FormLabel>
        </Grid>
        <Box
          sx={{
        ...
        >
          ...
          <Field
            ...
            type="text"
            component={renderStockAvailabilityStatusField}
            style={{ marginTop: 10 }}
          />
...
export default reduxForm({
  form: "confirmStockAvailabilityForm",
