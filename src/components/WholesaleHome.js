...
import TopCoverWholesale from "./homePageCards/TopCoverWholesale";
...
const WholesaleHome = (props) => {
  ...
  const [path, setPath] = useState("wholesale");
  const [preference, setPreference] = useState("wholesale");
