...
import backgroundRating from "./../../assets/images/covers/rating3.png";
...
const useStyles = makeStyles((theme) => ({
  ...
  backgroundRating: {
    backgroundImage: `url(${backgroundRating})`,
    backgroundPosition: "center",
    backgroundSize: "cover",
    //backgroundAttachment: "fixed",
    backgroundRepeat: "no-repeat",
...
export default function EntityRating(props) {
      ...
      {matchesMDUp ? (
        <Card className={classes.root} disableRipple={true}>
          ...
          <Grid
            container
            direction="row"
            style={{ marginTop: 20, height: "100%", marginLeft: "15em" }}
          >
            {/* <Grid
              container
              direction="row"
            ...
            <Grid
              ...
              //direction="row"
              alignItems="center"
              className={classes.backgroundRating}
            ...
            <Grid
              item
              alignItems="center"
              //   style={{ height: "40%", marginLeft: "3.5em", width:'30%' }}
              style={{
                height: "60%",
                marginLeft: "1.5em",
                width: "30%",
        ...
        <Card className={classes.rootMobile} disableRipple>
          <Grid
            container
            direction="row"
            style={{ marginTop: 5, height: "100%", marginLeft: "1.5em" }}
          >
            {/* <Grid
              container
              direction="column"
